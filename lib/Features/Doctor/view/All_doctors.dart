            ...
            Stack(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: IconButton(
                    icon: Icon(
                      notifier.isFavorite(doctorId)
                          ? FontAwesomeIcons.solidHeart
                          : FontAwesomeIcons.heart,
                      color: notifier.isFavorite(doctorId)
                          ? Colors.red
                          : Colors.black,
                      size: 24,
                    ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text(
                          'سعر الحجز: ${NumberFormat.currency(symbol: 'جنيه ', decimalDigits: 0).format(doctor['consultationFee'])}',
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,

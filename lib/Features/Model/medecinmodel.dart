...
final categories = [
  ...
  Category(
    ...
    medicines: [
      Medicine(
        name: 'معجون الأسنان Sensodyne',
        imageUrl: Assets.sensodyne.path,
        price: 8.99,
        description:
            'معجون الأسنان Sensodyne مصمم خصيصاً لتخفيف حساسية الأسنان. يوفر حماية طويلة الأمد ضد الألم الناتج عن الأطعمة الساخنة أو الباردة. يحتوي على مكونات مهدئة تساعد في تقوية الأسنان وتوفير حماية شاملة ضد تسوس الأسنان.',
      ),
      Medicine(
        name: 'غسول الفم Listerine',
        imageUrl: Assets.listerine.path,
        price: 7.49,
        description:
            'غسول الفم Listerine يساهم في تحسين صحة الفم بشكل فعال. يتميز بتركيبته القوية التي تساعد في قتل البكتيريا المسببة للتسوس ورائحة الفم الكريهة. يستخدم كجزء من روتين العناية بالفم اليومي لضمان نظافة الفم والأسنان.',
      ),
      Medicine(
        name: 'معجون الأسنان Parodontax',
        imageUrl: Assets.parodontax.path,
        price: 9.49,
        description:
            'معجون الأسنان Parodontax يحتوي على مكونات طبيعية تساعد في محاربة نزيف اللثة والحفاظ على صحة الأسنان. يتميز بتركيبة خاصة تعمل على تقوية اللثة والأسنان، مما يساعد في منع المشكلات المرتبطة باللثة والتسوس.',
      ),
    ],
  ),
];
